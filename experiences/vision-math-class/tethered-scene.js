...
/** @typedef {import('../../src/index.js').MadFlyLab} MadFlyLab */
/** @typedef {import('../../src/training/q-learning.js').QReadout} QReadout */

import { TrainingLoop, CSS } from '../../src/index.js';
import { TrainingHUD } from '../../src/observer/training-hud.js';
import { MathClassTask, MATH_CLASS_FEATURE_CHANNELS } from './vision-math-task.js';
...
export function enterVisionMathClass(lab, opts = {}) {
...
export const experienceInfo = {
  label: 'Math Class (Even vs. Odd)',
  description: 'Stationary. Dot counts via smell; a readout learns.'
};